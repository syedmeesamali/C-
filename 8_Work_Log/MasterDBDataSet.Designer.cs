...
namespace Work_Log {
    ...
    public partial class MasterDBDataSet : global::System.Data.DataSet {
        ...
        public partial class ProductsDataTable : global::System.Data.TypedTableBase<ProductsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ProductsRow AddProductsRow(int ID, string ProdID, string ProdName) {
...
namespace Work_Log.MasterDBDataSetTableAdapters {
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Products] WHERE (([ID] = @Original_ID) AND ([ProdID] = @Origin" +
                "al_ProdID) AND ([ProdName] = @Original_ProdName))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Products] ([ID], [ProdID], [ProdName]) VALUES (@ID, @ProdID, @" +
                "ProdName);\r\nSELECT ID, ProdID, ProdName FROM Products WHERE (ID = @ID)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Products] SET [ID] = @ID, [ProdID] = @ProdID, [ProdName] = @ProdNam" +
                "e WHERE (([ID] = @Original_ID) AND ([ProdID] = @Original_ProdID) AND ([ProdName]" +
                " = @Original_ProdName));\r\nSELECT ID, ProdID, ProdName FROM Products WHERE (ID = " +
                "@ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Work_Log.Properties.Settings.Default.MasterDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, ProdID, ProdName FROM dbo.Products";
        ...
        public virtual int Fill(MasterDBDataSet.ProductsDataTable dataTable) {
        ...
        public virtual MasterDBDataSet.ProductsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            MasterDBDataSet.ProductsDataTable dataTable = new MasterDBDataSet.ProductsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(MasterDBDataSet.ProductsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_ID, string Original_ProdID, string Original_ProdName) {
        ...
        public virtual int Insert(int ID, string ProdID, string ProdName) {
        ...
        public virtual int Update(int ID, string ProdID, string ProdName, int Original_ID, string Original_ProdID, string Original_ProdName) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string ProdID, string ProdName, int Original_ID, string Original_ProdID, string Original_ProdName) {
            return this.Update(Original_ID, ProdID, ProdName, Original_ID, Original_ProdID, Original_ProdName);
        }
    }
